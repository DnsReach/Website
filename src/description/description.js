        ...
        <>
            <div className="desc-text">
                ...
                <h4>
                    ...
                    Acess them wherever you need, share and collaborate with friends family,
                    and co-workers.
                </h4>
            ...
            <div id="grid">
                <nav>
                    ...
                    <div style={{ marginLeft: 20 }}>
                        <p> 2-factor authentication and user-controlled encryption are just a</p>
                        <p>couple of the security features we allow to help   secure your files. </p>
                    </div>
                </nav>
                <Files />
            </div>
